...
/**
 * Интерфейс ServiceApiImpl. Имплементирует методы из интерфейса.
 *
 * @author Nick
 * @version 1.0
 */
...
public class ServiceApiImpl implements ServiceApi {
    ...
    /**
     * Метод позволяет получить список всех персонажей.
     *
    ...
    /**
     * Метод позволяет получить информацию о персонаже по его идентификатору.
     *
    ...
    /**
     * Метод позволяет получить коллекцию персонажей с определенной страницы.
     *
    ...
    /**
     * Метод позволяет получить номер страницы, на которой находится персонаж с указанным идентификатором.
     *
     * @param id Идентификатор персонажа
    ...
    /**
     * Метод позволяет получить отфильтрованную коллекцию персонажей.
     *
